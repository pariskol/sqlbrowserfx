...
public class DockTitleBar extends HBox implements EventHandler<MouseEvent> {
	...
	/**
	 * The button used for detaching, maximizing, or restoring this title bar and
	...
	/**
	 * The mouse location of the original click which we can use to determine the
	 * offset during drag. Title bar dragging is asynchronous so it will not be
	 * negatively impacted by less frequent or lagging mouse events as in the case
	 * of most current JavaFX implementations on Linux.
	 */
	 ...
	 * @param explicit  The explicit event to be fired on the stage root when no
