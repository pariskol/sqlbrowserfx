...
//		this.setRoot(rootItem);
    ...
    /**
     * This is function is needed because postgresql and mysql have same column names for some result sets but with different cases. It is being used in getFunctionsAndProcedures() method.
     *
     * @param map
     * @param col
     * @return
