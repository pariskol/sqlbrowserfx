...
public class FileTypeScriptCodeArea extends TypeScriptCodeArea implements FileCodeArea {

	private final File file;
	private String lastSavedContent;
	
	public FileTypeScriptCodeArea(File file) {
		super();
		this.setHasSimpleContextMenu(true);
		this.file = file;
