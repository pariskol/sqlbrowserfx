...
public class DTOMapper {
    ...
    /**
     * Maps a row of result set into a HashMap. For mapping columns aliases are used.
     *
     * @param rset
    ...
    public static LinkedHashMap<String, Object> map(ResultSet rset) throws Exception {
        ...
        for (int i = 1; i <= rsmd.getColumnCount(); i++) {
            ...
            if (value != null) {
                ...
                dto.put(rsmd.getColumnLabel(i), rset.getObject(i));
            }
        }
    ...
    /**
     * Maps a row of result set into a HashMap. For mapping columns real names are used.
     *
     * @param rset
     * @return LinkedHashMap
     * @throws Exception
    ...
    public static LinkedHashMap<String, Object> mapUsingRealColumnNames(ResultSet rset) throws Exception {
        ...
        for (int i = 1; i <= rsmd.getColumnCount(); i++) {
            ...
            if (value != null) {
                ...
                dto.put(rsmd.getColumnName(i), rset.getObject(i));
            }
        }
    ...
    /**
     * Maps a row of result set in a given class (which has @DTO annotation and its fields have @Column annotation). Database's column types and class fields must be type compatible.
     *
     * @param rset
     * @param clazz
     * @return
